...
📌 *Select a category from the list below:*`;
  ...
  const cmdDescMap = {
    ...
    arabic: {
      ...
      'nameinspace': 'صور الفضاء باسمك',
      'satellite': 'صور الأقمار الصناعية الفضائية',
      'vocalremover': 'عزل صوت المغني عن الموسيقى ديال أي أوديو/فيديو',
      '3azlsawt': 'عزل صوت المغني عن الموسيقى بالذكاء الاصطناعي',
      'hazf-sawt': 'عزل صوت المغني عن الموسيقى بالذكاء الاصطناعي',
